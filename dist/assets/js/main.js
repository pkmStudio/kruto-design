...
// Пример: { Navigation, Pagination, Autoplay }
...
function initSliders() {
    ...
    if (document.querySelector('.team-slider') && window.innerWidth < 768) { // Указываем скласс нужного слайдера
        // Создаем слайдер
        new swiper_core_Swiper('.team-slider', { // Указываем скласс нужного слайдера
    ...
    // Проверяем, есть ли слайдер на странице
    if (document.querySelector('.otzivi-slider') && window.innerWidth < 768) { // Указываем скласс нужного слайдера
        // Создаем слайдер
        new swiper_core_Swiper('.otzivi-slider', { // Указываем скласс нужного слайдера
            // Подключаем модули слайдера
            // для конкретного случая
            modules: [Pagination],
            slidesPerView: 'auto',
...
;// ./src/assets/components/social-section/social-section.js
...
;// ./src/assets/components/accordion-item/accordion-item.js
document.addEventListener('DOMContentLoaded', () => {
